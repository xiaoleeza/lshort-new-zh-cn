...
\bibitem{survey} Stephen G. Hartke.
   \newblock \emph{A Survey of Free Math Fonts for \TeX\ and \LaTeX}, an introduction of 
   combination of text and math fonts in \LaTeX.
   \newblock Downloadable from \CTAN|info/Free_Math_Font_Survey/survey.pdf|

\bibitem{fontcatalogue} 
   \newblock \emph{The \LaTeX\ font catalogue}, a font catalogue of \LaTeX\ font packages.
   \newblock Available online from \url{http://www.tug.dk/FontCatalogue/}
\end{thebibliography}
